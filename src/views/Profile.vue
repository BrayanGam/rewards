...
<template>
  <div class="p-6 space-y-8 max-w-lg mx-auto pb-24">
    <div class="text-center space-y-4">
      <div class="w-32 h-32 bg-pink-50 rounded-full mx-auto flex items-center justify-center border-4 border-white shadow-sm overflow-hidden relative p-1.5">
        <img 
      ...
      <div>
        <h1 class="text-2xl font-bold font-serif">{{ profile?.username || 'Mi Amor' }}</h1>
        <p class="text-gray-500 text-sm">{{ user?.email }}</p>
      </div>
    </div>

    <!-- Relationship Stats -->
    <div class="glass p-8 space-y-6 shadow-2xl ring-1 ring-white/20">
